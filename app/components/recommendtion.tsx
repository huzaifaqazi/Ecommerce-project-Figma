...
const Recommendtion = () => {
  return (
    <div className="h-[1100px] bg-[#F6F7F9] p-14">
        <div className="">
            <h1 className="text-[#90A3BF]">Recommendation</h1>
            <div className="flex justify-between items-center my-4">
          <div className="w-[350px] h-[400px] bg-[#ffffff]">
        ...
        {/* container 2 */}
        <div className="my-14 bg-[#F6F7F9] flex justify-between items-center">
        <div className="w-[350px] h-[400px] bg-[#ffffff]">
...
<div className="bg-[#3563E9] p-3 rounded my-10 text-white mx-4 w-[120px] text-center">
<button className="">Rent Now</button>
</div>
</div>
</div>
